...
sys.path.append('./')
sys.path.insert(0, "/home/share/huadjyin/home/s_sukui/03_project/01_GeneLLM/DNABERT_S/train/pretrain")
...
def get_args(argv):
    ...
    parser.add_argument('--gpuid', nargs="+", type=int, default=[0],
                        help="The list of gpuid. Negative value means cpu-only")
    parser.add_argument('--seed', type=int, default=1, help="Random seed")
    parser.add_argument('--resdir', type=str, default="./results")
    parser.add_argument('--logging_step', type=int, default=10000,
                        help="How many iteration steps to save the model checkpoint and loss value once")
    ...
    parser.add_argument('--con_method', type=str, default='same_species',
                        help="Which data augmentation method used, include dropout, double_strand, mutate, same_species")
    parser.add_argument('--mix', action="store_true", help="Whether use i-Mix method")
    parser.add_argument('--dnabert2_mix_dict', type=str, default="./DNABERT-2-117M-MIX",
                        help="Dictionary of the modified code for DNABert-2 to perform i-Mix")
    parser.add_argument('--mix_alpha', type=float, default=1.0, help="Value of alpha to generate i-Mix coefficient")
    parser.add_argument('--mix_layer_num', type=int, default=-1,
                        help="Which layer to perform i-Mix, if the value is -1, it means manifold i-Mix")
